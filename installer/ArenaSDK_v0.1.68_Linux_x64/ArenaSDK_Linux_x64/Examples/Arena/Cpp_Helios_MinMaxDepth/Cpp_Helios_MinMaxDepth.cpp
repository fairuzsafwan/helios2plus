...
// file name
#define FILE_NAME "/temp/Helios_MinMaxDepth.ply"
//#define FILE_NAME_DEPTHMAP "/temp/depthmap.png"
//#define FILE_NAME_DEPTHMAP2 "/temp/depthmap_2.png"
//#define FILE_NAME_BITMAP "/temp/depthmap.bmp"
#define FILE_NAME_DEPTHMAP_16UC1 "/temp/depthmap_16UC1.png"
#define FILE_NAME_DEPTHMAP_8UC1 "/temp/depthmap_8UC1.png"
#define FILE_NAME_DEPTHMAP_16UC1_2 "/temp/depthmap2_16UC1.png"
#define FILE_NAME_DEPTHMAP_8UC1_2 "/temp/depthmap2_8UC1.png"
...
void AcquireImageAndInterpretData(Arena::IDevice* pDevice, size_t k)
{
	...
	else if (compareResult_ABC16 == 0)
	{
		...
		for (size_t i = 0; i < size; i++)
		{
			...
			if (z < 65535)
			{
				...
				//size_t offset_x_temp = 250;//250; //640
				//size_t offset_y_temp = 120;//120; //400
				...
				// if ((pixel_pos_x < (width-1)) && (pixel_pos_y < (height-1)))
				// {
				// 	std::cout<< "x3: " << x << std::endl;
				// 	std::cout<< "y3: " << y << std::endl;
				// 	std::cout<< "z3: " << z << std::endl;
				...
				// 	std::cout<< "distort_val: " << distort_val << std::endl;
				// 	std::cout<< "pixel_pos_x17: " << pixel_pos_x << std::endl;
				// 	std::cout<< "pixel_pos_y17: " << pixel_pos_y << std::endl << std::endl;
				// 	countA = countA + 1;
				// }
				// 	countB = countB + 1;
				...
				// 	pixel_y = pixel_y + 1;
				// }
				// cv_image.at<float>(pixel_y,pixel_x) = z;
	...
	// std::cout<< "countA: " << std::to_string(countA) << std::endl;
	// std::cout<< "countB: " << std::to_string(countB) << std::endl;

	// Arena::IImage* pCreate = Arena::ImageFactory::Create(pOutput, dstDataSize, width, height, PIXEL_FORMAT_BMP);
	// Save::ImageParams bmpParams(width, height, dstBpp);
	// Save::ImageWriter bmpWriter(bmpParams, FILE_NAME_BITMAP);
	// bmpWriter << pCreate->GetData();
