...
#define FILE_NAME_CALIB_V1 "/temp/calibration_helios_triton/orientation_v1.yml"


// orientation values file name
#define FILE_NAME_OUT "/temp/calibration_helios_triton/orientation_v2.yml"
...
void CalculateAndSaveOrientationValues(Arena::IDevice* pDeviceTRI, Arena::IDevice* pDeviceHLT)
{
	...
	cv::FileStorage fs(FILE_NAME_CALIB_V1, cv::FileStorage::READ);
	cv::Mat cameraMatrix_v1;
	cv::Mat distCoeffs_v1;
	
	fs["cameraMatrix"] >> cameraMatrix_v1;
	fs["distCoeffs"] >> distCoeffs_v1;
	...
	//Undistort RGB
	//cv::Mat rgb_calib;
	//cv::undistort(imageMatrixTRI, rgb_calib, cameraMatrix_v1, distCoeffs_v1);
